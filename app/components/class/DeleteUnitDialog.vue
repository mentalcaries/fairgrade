...
const isDeleteConfirmValid = computed(() => {
  ...
  return deleteConfirmText.value.toLowerCase() === props.unit.name.toLowerCase()
})
  ...
  <Dialog :open="open" @update:open="emit('update:open', $event)">
    <DialogContent class="max-w-md">
      ...
      <div class="space-y-4 py-4">
        <div class="flex items-start gap-3 p-3 bg-red-50 text-red-700 rounded-lg">
        ...
        <div class="space-y-2">
          ...
          <ul class="list-disc list-inside text-sm text-muted-foreground space-y-1 ml-2">
            ...
            <li v-if="unit?.instructorId">Remove consultant assignment</li>
          </ul>
        </div>
        ...
        <div class="space-y-2">
          ...
          />
          <p v-if="deleteConfirmText && !isDeleteConfirmValid" class="text-xs text-red-500">
